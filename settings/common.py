# -*- coding: utf-8 -*-
"""Django settings for startupintro project.
...
APPS_DIR = ROOT_DIR.path('startupintro')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'startupintro.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'EXCEPTION_HANDLER': 'startupintro.base.exceptions.exception_handler',
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'startupintro.urls'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/startupintro'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'startupintro.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'startupintro.base.views.csrf_failure'
